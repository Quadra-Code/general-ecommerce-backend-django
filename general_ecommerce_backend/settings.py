"""
Django settings for general_ecommerce_backend project.
...
ROOT_URLCONF = 'general_ecommerce_backend.urls'
...
WSGI_APPLICATION = 'general_ecommerce_backend.wsgi.application'
